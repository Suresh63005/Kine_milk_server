...
const { registerAdminSchema, loginAdminSchema, updateAdminSchema, deleteAdminSchema, getAdminbyIdSchema, searchAdminSchema } = require("../utils/validation");
...
const registerAdmin = asynHandler(async (req, res) => {
  ...
  // }
    ...
    //   return res.status(400).json({ error: "Invalid role. Role must be 'admin' or 'store'." });
    // }
